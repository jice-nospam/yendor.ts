...
import * as inp from "./input_virtual";
    ...
    */
    export function isKeyDown(key: con.KeyCode): boolean {
    ...
    /**
        ...
        key - the key code to check
    */
    export function wasKeyPressed(key: con.KeyCode): boolean {
    ...
    */
    export function wasKeyReleased(key: con.KeyCode): boolean {
    ...
    */
    ...
    export function onMouseMove(event: JQueryMouseEventObject, console: Yendor.Console) {
        mouseStatus.pixelPos.x = event.pageX;
        mouseStatus.pixelPos.y = event.pageY;
        if ( console ) {
            console.getPositionFromPixels(event.pageX, event.pageY, mouseStatus.cellPos);
        }
    ...
    export function onMouseDown(event: JQueryMouseEventObject) {
        ...
        inp.updateMouseButtonAxes(<con.MouseButton>event.which, true);
    }
    ...
    export function onMouseUp(event: JQueryMouseEventObject) {
        ...
        inp.updateMouseButtonAxes(<con.MouseButton>event.which, false);
    }

    export function onKeypress(event: KeyboardEvent) {
        charPressed[event.charCode] = true;
        inp.updateAsciiCodeAxes(event.charCode);
    }
    ...
    export function onKeydown(event: KeyboardEvent) {
        ...
        inp.updateKeyCodeAxes(event.keyCode, true);
    }
    ...
    export function onKeyup(event: KeyboardEvent) {
        ...
        inp.updateKeyCodeAxes(event.keyCode, false);
    }
