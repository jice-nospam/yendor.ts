...
export type ButtonDef = string | number | con.MouseButton;
...
export function updateMouseButtonAxes(button: con.MouseButton, pressed: boolean) {
    let val = pressed ? 1 : 0;
...
export function updateAsciiCodeAxes(asciiCode: con.MouseButton) {
