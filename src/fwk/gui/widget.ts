    ...
    */
    ...
    show() {
        if (this.modal) {
            ...
            Umbra.EventManager.publishEvent(evn.EventType[evn.EventType.MODAL_SHOW], this);
        }
        super.show();
    }
    hide() {
        if (this.modal) {
            ...
            Umbra.EventManager.publishEvent(evn.EventType[evn.EventType.MODAL_HIDE], this);
        }
        super.hide();
    }
