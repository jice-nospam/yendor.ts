...
*/
export class Rect extends pos.Position implements pos.Comparable {
    /**
        Property: w
    */
    w: number;
    ...
    */
    contains(p: pos.Position): boolean;
    contains(px: number, py: number): boolean;
    contains(px: number|pos.Position, py?: number) {
        if (typeof px === "number") {
